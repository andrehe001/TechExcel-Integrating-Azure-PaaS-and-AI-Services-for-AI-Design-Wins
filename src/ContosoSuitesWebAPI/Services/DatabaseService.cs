...
public class DatabaseService(string connectionString) : IDatabaseService
{
    ...
    /// </summary>
    [KernelFunction]
    [Description("Get all bookings by hotel and minimum booking date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("The minimum date for booking")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("The booking with missing rooms")]
    ...
    [KernelFunction]
    [Description("The bookings with multiple rooms")]
